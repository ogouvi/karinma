        ...
        <section id="faq" className="py-10 lg:py-20">
            <div className="flex flex-col lg:flex-row gap-10">
                <div className="">
                    ...
                    <SectionTitle>
                        <h2 className="my-3 !leading-snug lg:max-w-sm text-center lg:text-left">Questions frequenment posées</h2>
                    </SectionTitle>
                    <p className="lg:mt-10 text-foreground-accent text-center lg:text-left">
                        Posez toutes vos questions!
                    </p>
                    <a href="mailto:" className="mt-3 block text-lg lg:text-3xl  font-semibold hover:underline text-center lg:text-left">contactkarinma@gmail.com</a>
                </div>
